...
By Carol Browning
Adapted to solve the crossing a bridge with flashlight problem
By Samuel Rudqvist
January 20, 2020
...
# but it can only hold two people at a time. They have one torch and, 
...
# they must move at the slower person's pace. The question is, 
...
# Time left starts at 15 minutes in seconds.
EAST = 1   
WEST = -1
TIME_LEFT = 900

# A state list will be a list of sides (east or west and time left) in the order
